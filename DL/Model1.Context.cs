...
namespace DL
{
    ...
    public partial class ATranquilinoLeenkenGroupEntities : DbContext
    {
        public ATranquilinoLeenkenGroupEntities()
            : base("name=ATranquilinoLeenkenGroupEntities")
        {
        }
        ...
        public virtual ObjectResult<EmpleadosGetAll_Result> EmpleadosGetAll()
        {
